...
\begin{onecolentry}
	\begin{highlights}
		\item Built Apps and Websites for the company.
		\item Currently building \& maintaining infrastructure and backend of 3 SaaS products.
		\item Also maintaining two core packages.
	\end{highlights}
\end{onecolentry}
