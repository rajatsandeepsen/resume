...
\begin{header}
	...
	\AND%
	\kern 5.0 pt%
	\mbox{\hrefWithoutArrow{https://rajatsandeepsen.github.io/}{https://rajatsandeepsen.github.io}}%
	\kern 5.0 pt%
	\AND%
	\kern 5.0 pt%
...
\begin{onecolentry}
	Self-taught Full Stack Developer, App Developer, DevOps, AI Engineer, and FOSS enthusiast
\end{onecolentry}

\vspace{0.2 cm}

\begin{onecolentry}
	Freelancer and Open Source Contributor. Lead FOSS, Tech \& Entrepreneurship communities in campus. Recently started working in startup as CTO.
\end{onecolentry}
...
\begin{onecolentry}
	\begin{highlights}
		...
		\item CGPA: 8.04 % (\href{https://example.com}{Transcript})
...
\begin{twocolentry}{
	...
	\textbf{Creator}, FindMyCrush App\end{twocolentry}

\vspace{0.10 cm}
\begin{onecolentry}
	\begin{highlights}
		\item Built and published a fun dating app for college students.
		\item Marketed the app in colleges and got 1700+ downloads in first month.
		\item Used tech stack Expo, React Native, \& Postgres.
	\end{highlights}
\end{onecolentry}
...
\begin{twocolentry}{
	...
	\textbf{Chief Technical Officer}, Manolo Ventures Pvt Ltd -- Palai, Kottayam\end{twocolentry}
...
\begin{twocolentry}{
	...
	\textbf{Senior Project Manager}, Manolo Ventures Pvt Ltd -- Palai, Kottayam\end{twocolentry}
...
\begin{twocolentry}{
		\href{https://jem.manolo.in}{jem.manolo.in}
	}
	\textbf{Jem Manolo}\end{twocolentry}

\vspace{0.10 cm}
\begin{onecolentry}
	\begin{highlights}
		\item Developed an Ecommerce website for customizing Jewellery with 3D preview and AR view for the company Manolo.
		\item Tech Stack: TypeScript, ThreeJs, React, TailwindCSS, Cloudflare
	\end{highlights}
\end{onecolentry}
...
\begin{twocolentry}{
		\href{https://github.com/rajatsandeepsen/sarvam-ai-sdk}{npmjs/sarvam-ai-sdk}
	}
	\textbf{Sarvam AI SDK}\end{twocolentry}

\vspace{0.10 cm}
\begin{onecolentry}
	\begin{highlights}
		\item Developed a package to bring Sarvam provider support for Vercel's AI-SDK, enabling developers to easily use Sarvam's models in their applications.
		\item Tech Stack: TypeScript, AI-SDK, Sarvam API
	\end{highlights}
\end{onecolentry}
...
\begin{twocolentry}{
		\href{https://github.com/manolo-in/hono-cf}{npmjs/hono-cf}
	}
	\textbf{Hono Cloudflare}\end{twocolentry}

\vspace{0.10 cm}
\begin{onecolentry}
	\begin{highlights}
		\item Developed a package for Hono framework to improve developer experience while using with Cloudflare
		\item Tech Stack: TypeScript, Hono, Cloudflare Workers
	\end{highlights}
\end{onecolentry}
...
\begin{onecolentry}
	\textbf{Libraries:} Reactjs, React-Native, Expressjs, TailwindCSS, LangChain, DrizzleORM, oRPC, Better-Auth, Hono, FastAPI, Pandas etc
\end{onecolentry}
\vspace{0.2 cm}
